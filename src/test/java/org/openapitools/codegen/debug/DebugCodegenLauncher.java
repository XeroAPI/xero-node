...
public class DebugCodegenLauncher 
{
  ...
  public void launchCodeGeneratorInDebugMode()
  {
    ...
    // this allows you to easily set break points in DefaultGenerator.
    String commandLineParams =
        ...
        "-t ./src/main/resources/default "+          // template directory
        "-o out/default "+                           // output directory
        "-g default ";                               // use this codegen library
