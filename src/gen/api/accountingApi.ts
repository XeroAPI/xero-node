...
export class AccountingApi {
     ...
     */     
    public async createBrandingThemePaymentServices (xeroTenantId: string, brandingThemeID: string, paymentServices: PaymentServices, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaymentServices;  }> {
     ...
     */     
    public async deleteBatchPayment (xeroTenantId: string, batchPaymentDelete: BatchPaymentDelete, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchPayments;  }> {
        const localVarPath = this.basePath + '/BatchPayments';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
     ...
     */     
    public async deleteBatchPaymentByUrlParam (xeroTenantId: string, batchPaymentID: string, batchPaymentDeleteByUrlParam: BatchPaymentDeleteByUrlParam, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchPayments;  }> {
