  ...
  */     
  public async createAccount (xeroTenantId: string, account: Account, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Accounts;  }> {
    ...
    let gotOptions: any = {
      ...
      json: ObjectSerializer.serialize(account, "Account")
    };

    let authenticationPromise = Promise.resolve();
    authenticationPromise = authenticationPromise.then(() => this.authentications.OAuth2.applyToRequest(gotOptions));

    authenticationPromise = authenticationPromise.then(() => this.authentications.default.applyToRequest(gotOptions));
    return authenticationPromise.then(() => {
      if (Object.keys(localVarFormParams).length) {
        if (localVarUseFormData) {
          // files api TODO
          (<any>gotOptions).formData = localVarFormParams;
        } else {
          gotOptions.form = localVarFormParams;
        }
      }
...
/**
  ...
  */     
  public async createAccountAttachmentByFileName (xeroTenantId: string, accountID: string, fileName: string, body: fs.ReadStream, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Attachments;  }> {
    ...
    localVarUseFormData = true; // Xero-OpenAPI x-isAttachment == true
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(body, "string")
    };
    ...
    return authenticationPromise.then(() => {
      if (Object.keys(localVarFormParams).length) {
        console.log('localVarFormParams, ',localVarFormParams)
        if (localVarUseFormData) {
            // files api TODO
            console.log('sup dawg')
            delete gotOptions.json
            gotOptions.body = localVarFormParams;
        }
        else {
            console.log('sup dawg else')
            gotOptions.body = localVarFormParams;
        }
      }
    }).then(() => {
      ...
      return new Promise<{ response: http.IncomingMessage; body: Attachments;  }>((resolve, reject) => {
        (async (response, body) => {
          try {
            ...
            if(gotOptions.body){
              console.log('***********************');
              console.log(typeof gotOptions.body);
            }
            response = await got.call('PUT'.toLowerCase(), localVarPath, gotOptions)
            body = JSON.parse(response.body)        
  ...
  */     
  public async createBankTransactionHistoryRecord (xeroTenantId: string, bankTransactionID: string, historyRecords: HistoryRecords, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HistoryRecords;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(historyRecords, "HistoryRecords")
    };
  ...
  */     
  public async createBankTransactions (xeroTenantId: string, bankTransactions: BankTransactions, summarizeErrors?: boolean, unitdp?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BankTransactions;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(bankTransactions, "BankTransactions")
    };
  ...
  */     
  public async createBankTransfer (xeroTenantId: string, bankTransfers: BankTransfers, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BankTransfers;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(bankTransfers, "BankTransfers")
    };
  ...
  */     
  public async createBatchPayment (xeroTenantId: string, batchPayments: BatchPayments, summarizeErrors?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchPayments;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(batchPayments, "BatchPayments")
    };
  ...
  */     
  public async createBrandingThemePaymentServices (xeroTenantId: string, brandingThemeID: string, paymentService: PaymentService, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaymentServices;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(paymentService, "PaymentService")
    };
  ...
  */     
  public async createContactGroup (xeroTenantId: string, contactGroups: ContactGroups, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContactGroups;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(contactGroups, "ContactGroups")
    };
  ...
  */     
  public async createContactGroupContacts (xeroTenantId: string, contactGroupID: string, contacts: Contacts, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Contacts;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(contacts, "Contacts")
    };
  ...
  */     
  public async createCreditNoteAllocation (xeroTenantId: string, creditNoteID: string, allocations: Allocations, summarizeErrors?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Allocations;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(allocations, "Allocations")
    };
  ...
  */     
  public async createCreditNotes (xeroTenantId: string, creditNotes: CreditNotes, summarizeErrors?: boolean, unitdp?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CreditNotes;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(creditNotes, "CreditNotes")
    };
  ...
  */     
  public async createCurrency (xeroTenantId: string, currency: Currency, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Currencies;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(currency, "Currency")
    };
  ...
  */     
  public async createEmployees (xeroTenantId: string, employees: Employees, summarizeErrors?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Employees;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(employees, "Employees")
    };
  ...
  */     
  public async createExpenseClaims (xeroTenantId: string, expenseClaims: ExpenseClaims, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ExpenseClaims;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(expenseClaims, "ExpenseClaims")
    };
  ...
  */     
  public async createInvoices (xeroTenantId: string, invoices: Invoices, summarizeErrors?: boolean, unitdp?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Invoices;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(invoices, "Invoices")
    };
  ...
  */     
  public async createItems (xeroTenantId: string, items: Items, summarizeErrors?: boolean, unitdp?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Items;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(items, "Items")
    };
  ...
  */     
  public async createLinkedTransaction (xeroTenantId: string, linkedTransaction: LinkedTransaction, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LinkedTransactions;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(linkedTransaction, "LinkedTransaction")
    };
  ...
  */     
  public async createManualJournals (xeroTenantId: string, manualJournals: ManualJournals, summarizeErrors?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ManualJournals;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(manualJournals, "ManualJournals")
    };
  ...
  */     
  public async createPayment (xeroTenantId: string, payment: Payment, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Payments;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(payment, "Payment")
    };
  ...
  */     
  public async createPaymentService (xeroTenantId: string, paymentServices: PaymentServices, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaymentServices;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(paymentServices, "PaymentServices")
    };
  ...
  */     
  public async createPayments (xeroTenantId: string, payments: Payments, summarizeErrors?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Payments;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(payments, "Payments")
    };
  ...
  */     
  public async createPurchaseOrders (xeroTenantId: string, purchaseOrders: PurchaseOrders, summarizeErrors?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PurchaseOrders;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(purchaseOrders, "PurchaseOrders")
    };
  ...
  */     
  public async createQuotes (xeroTenantId: string, quotes: Quotes, summarizeErrors?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Quotes;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(quotes, "Quotes")
    };
  ...
  */     
  public async createReceipt (xeroTenantId: string, receipts: Receipts, unitdp?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Receipts;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(receipts, "Receipts")
    };
  ...
  */     
  public async createTaxRates (xeroTenantId: string, taxRates: TaxRates, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TaxRates;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(taxRates, "TaxRates")
    };
  ...
  */     
  public async createTrackingCategory (xeroTenantId: string, trackingCategory: TrackingCategory, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TrackingCategories;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(trackingCategory, "TrackingCategory")
    };
  ...
  */     
  public async createTrackingOptions (xeroTenantId: string, trackingCategoryID: string, trackingOption: TrackingOption, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TrackingOptions;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(trackingOption, "TrackingOption")
    };
  ...
  */     
  public async deletePayment (xeroTenantId: string, paymentID: string, paymentDelete: PaymentDelete, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Payments;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(paymentDelete, "PaymentDelete")
    };
  ...
  */     
  public async emailInvoice (xeroTenantId: string, invoiceID: string, requestEmpty: RequestEmpty, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(requestEmpty, "RequestEmpty")
    };
  ...
  */     
  public async postSetup (xeroTenantId: string, setup: Setup, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ImportSummaryObject;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(setup, "Setup")
    };
  ...
  */     
  public async updateAccount (xeroTenantId: string, accountID: string, accounts: Accounts, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Accounts;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(accounts, "Accounts")
    };
  ...
  */     
  public async updateLinkedTransaction (xeroTenantId: string, linkedTransactionID: string, linkedTransactions: LinkedTransactions, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LinkedTransactions;  }> {
    ...
    let gotOptions: any = {
      ...
      uri: localVarPath,
      useQuerystring: this._useQuerystring,
      json: ObjectSerializer.serialize(linkedTransactions, "LinkedTransactions")
    };
