...
export class PayrollAuApi {
     ...
     */     
    public async approveLeaveApplication (xeroTenantId: string, leaveApplicationID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LeaveApplications;  }> {
     ...
     * @param leaveApplicationID Leave Application id for single object
     */     
    public async rejectLeaveApplication (xeroTenantId: string, leaveApplicationID: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LeaveApplications;  }> {
