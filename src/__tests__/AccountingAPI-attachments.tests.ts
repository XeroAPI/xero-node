...
describe('AccountingAPI attachments', () => {
	...
	const fixtures: IFixture = {
		invoices: [
			...
			{ expectedPath: `invoices/${guid1}/attachments/bean%232.jpg`, args: { mimeType: 'image/jpg', pathToSave: tempAttachmentLocation, entityId: guid1, fileName: 'bean#2.jpg' } },
			{ expectedPath: `invoices/${guid1}/attachments/bean%232.jpg`, args: { mimeType: 'image/jpg', pathToSave: tempAttachmentLocation, entityId: guid1, fileName: 'bean%232.jpg' } }
		],
		bankTransactions: [
